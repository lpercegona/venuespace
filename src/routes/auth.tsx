...
function AuthPage() {
  ...
  return (
    ...
    before:bg-linear-to-tr before:from-surface/95 before:via-muted/95 before:to-primary/70
  "
          style={{ backgroundImage: "url('/public/Imagem-autenticacao-resize.jpg')" }}
        >
          <div className="absolute bottom-0 left-0 z-1 max-w-lg space-y-3 rounded-2xl border border-border bg-card/80 p-5 shadow-elegant backdrop-blur">
