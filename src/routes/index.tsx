...
function LocalidadesSection({
  ...
  return (
    <section className="py-12">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        <h2 className="mb-6 font-display text-lg font-bold tracking-tight sm:text-2xl">
        ...
        <div className="space-y-6">
          ...
          {bairrosSorted.length > 0 && (
            <div>
              <h3 className="mb-2 text-[0.625rem] font-semibold uppercase tracking-wider text-muted-foreground">Bairros</h3>
              <div className="text-[0.625rem] grid grid-cols-2 gap-x-4 gap-y-0.5 sm:grid-cols-4">
          ...
          {cidadesSorted.length > 0 && (
            <div>
              <h3 className="mb-2 text-[0.625rem] font-semibold uppercase tracking-wider text-muted-foreground">Cidades</h3>
              <div className="text-[0.625rem] grid grid-cols-2 gap-x-4 gap-y-0.5 sm:grid-cols-4">
