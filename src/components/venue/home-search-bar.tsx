...
export function HomeSearchBar({ categoryId, categorySlug }: Props) {
  ...
  return (
    <form
      ...
      className="mx-auto mt-8 flex w-full max-w-2xl items-center gap-2 rounded-full bg-transparent p-2 shadow-elegant"
    >
      <div className="relative min-w-0 grow">
        <Search className="bg-background/30 border rounded-full pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
        <Input
