...
ALTER TABLE public.tables ADD COLUMN IF NOT EXISTS is_public boolean NOT NULL DEFAULT false;
ALTER TABLE public.category_standard_tables ADD COLUMN IF NOT EXISTS is_public boolean NOT NULL DEFAULT false;
